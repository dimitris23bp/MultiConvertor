# Project Information for MultiConvertor

## Overview
This document contains important information about the MultiConvertor project that should be reviewed before performing any work. It serves as a reference for understanding the project structure, key components, and recent changes.

## Project Structure
- **Main App**: `MultiConvertor/` - Contains the main application code
- **Tests**: `MultiConvertorUnitTests/` and `MultiConvertorIntegrationTests/` - Test suites
- **Assets**: `MultiConvertor/Assets.xcassets/` - Image and color assets
- **Models**: `MultiConvertor/Models/` - Data models and DTOs
- **Services**: `MultiConvertor/Services/` - Business logic and API services
- **Views**: `MultiConvertor/Views/` - UI components and screens
...
xcodebuild -scheme MultiConvertor -destination 'platform=iOS Simulator,name=iPhone 15' build

# Check for specific errors
xcodebuild -scheme MultiConvertor build 2>&1 | grep -A 5 -B 5 "error:"
```
