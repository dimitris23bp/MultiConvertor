...
final class AllRepository {
    ...
    func addIfDontExist<T: CurrencyDTO>(withType type: T.Type, ids: Set<String>, currencies: [T]) async {
    ...
    func updateAmounts<T: CurrencyDTO>(withType type: T.Type, currencies: [T]) async {
