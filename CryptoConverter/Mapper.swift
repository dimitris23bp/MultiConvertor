...
final class Mapper: Sendable {
	...
	nonisolated static func mapCryptoRecordToDTO(record: CKRecord)
		-> CryptocurrencyDTO?
	{
	...
	nonisolated static func mapFiatRecordToDTO(record: CKRecord)
		-> FiatCurrencyDTO?
	{
		guard let id = record["id"] as? String,
			let name = record["name"] as? String,
	...
	nonisolated private static func convertCKAssetToData(_ asset: CKAsset)
		-> Data?
	{
